...
void OpenGLShader::setRenderSize(GLuint width, GLuint height) {
...
void OpenGLShader::createRenderTexture (GLuint texture, int width, int height)  {
...
void OpenGLShader::createRenderTexture (GLuint texture, int width, int height, void *buffer)  {
...
void OpenGLShader::createRenderTexture (GLuint texture, int width, int height, unsigned char *buffer)  {
...
/*
void OpenGLShader::drawToScreen(GLfloat top, GLfloat bottom, GLfloat left, GLfloat right) {
...
void OpenGLShader::printProgramInfoLog(GLuint obj) {
...
void OpenGLShader::printShaderInfoLog(GLuint obj) {
    int infologLength = 0;
    int charsWritten  = 0;
    char *infoLog;
...
void OpenGLShader::checkFBOStatus () {
